  ...
  'inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        umass3:
          'font-bold rounded-full bg-[rgb(255,100,100)] shadow-lg shadow-gray-400 p-6 cursor-none hover:scale-110 ease-in duration-300',
        selected:
        ...
        unselected:
          'rounded-full bg-[rgb(225,157,153)] shadow-lg shadow-gray-400 m-3 p-6 cursor-pointer ease-in duration-300',
      },
      size: {
